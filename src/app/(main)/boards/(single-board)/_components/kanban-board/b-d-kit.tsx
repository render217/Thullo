...
import {
  useUpdateBoardTaskCardOrder,
  useUpdateBoardTaskOrder,
} from "@/utils/hooks/useBoards";
import { UpdateBoardTaskCardOrderParams } from "@/utils/actions/shared.types";
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (activeData.type === "card" && overData.type === "card") {
      ...
      if (sourceTaskIndex === targetTaskIndex) {
        ...
        setTasks(updatedTasks);
        syncCardOrder(board?.boardId, targetTask.taskId, targetTask.cards);
        // syncCardOrder(board?.boardId, sourceTask.taskId, sourceTask.cards);
      }
      ...
      if (sourceIndex !== -1 && targetIndex !== -1) {
        ...
        setTasks(updatedTasks);
        syncTaskOrder(board?.boardId, updatedTasks);
      }
    }
