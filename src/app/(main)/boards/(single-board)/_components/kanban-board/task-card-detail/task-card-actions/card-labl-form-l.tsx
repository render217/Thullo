...
// import { labelColorsOption } from "@/lib/constants";
...
//   const [l, setL] = useState<TLabel[]>(card.labels);
...
//               onClick={() => {}}
//               size={"sm"}
//               className="mx-auto block h-6 text-[10px]"
//             >
//               Add Label
//             </Button>
//           </div>
